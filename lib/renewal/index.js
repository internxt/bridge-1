...
// DOWNLOAD SHARD FROM FARMER
const fs = require('fs');
const crypto = require('crypto');
const http = require('http');
const storj = require('storj-lib');

const SHARD_SOCKET_TIMEOUT = 90 * 1000; // 1.5 minutes, in milliseconds
const SHARD_TRANSFER_MAXTIME = 20 * 60 * 1000; // 20 minutes, in milliseconds
