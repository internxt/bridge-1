...
class Cleaner {
  constructor(config) {
    ...
    this.currentObjectId = new ObjectId('5f0b3c1bb599a177de3c4821');
 ...
 */
  ...
  clearFramesWithoutBucketEntries(callback) {
  ...
  clearFramesWithoutUser(callback) {
  ...
  clearShardsWithoutPointers(callback) {
  ...
  clearInvalidContracts(callback) {
  ...
  clearMirrorsWithoutContacts(callback) {
